...
public class Doctor_ViewNurses extends AppCompatActivity {
    ...
    private void createNurse() {
        ...
        Doctor_ViewNurses.PerformNetworkRequest request = new Doctor_ViewNurses.PerformNetworkRequest(Api.URL_CREATE_NURSE, params, CODE_POST_REQUEST);
        request.execute();
    }

    private void readNurses() {
        Doctor_ViewNurses.PerformNetworkRequest request = new Doctor_ViewNurses.PerformNetworkRequest(Api.URL_READ_NURSE, null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    private void updateNurse() {
        ...
        Doctor_ViewNurses.PerformNetworkRequest request = new Doctor_ViewNurses.PerformNetworkRequest(Api.URL_UPDATE_NURSE, params, CODE_POST_REQUEST);
        request.execute();
    ...
    private void deleteHero(int nurseid) {
        Doctor_ViewNurses.PerformNetworkRequest request = new Doctor_ViewNurses.PerformNetworkRequest(Api.URL_DELETE_NURSE + nurseid, null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    private void refreshHeroList(JSONArray nurses) throws JSONException {
        ...
        Doctor_ViewNurses.NurseAdapter adapter = new Doctor_ViewNurses.NurseAdapter(nurseList);
    ...
    class NurseAdapter extends ArrayAdapter<Nurse> {
        ...
        public NurseAdapter(List<Nurse> nurseList) {
            super(Doctor_ViewNurses.this, R.layout.layout_hero_list, nurseList);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textViewDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Doctor_ViewNurses.this);
