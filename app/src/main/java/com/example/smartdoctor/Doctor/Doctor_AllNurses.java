...
public class Doctor_AllNurses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_doctor__all_nurses);
    ...
    private void createNurse() {
        ...
        Doctor_AllNurses.PerformNetworkRequest request = new Doctor_AllNurses.PerformNetworkRequest(Api.URL_CREATE_NURSE, params, CODE_POST_REQUEST);
        request.execute();
    }

    private void readNurses() {
        Doctor_AllNurses.PerformNetworkRequest request = new Doctor_AllNurses.PerformNetworkRequest(Api.URL_READ_NURSE, null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    private void updateNurse() {
        ...
        Doctor_AllNurses.PerformNetworkRequest request = new Doctor_AllNurses.PerformNetworkRequest(Api.URL_UPDATE_NURSE, params, CODE_POST_REQUEST);
        request.execute();
    ...
    private void deleteHero(int nurseid) {
        Doctor_AllNurses.PerformNetworkRequest request = new Doctor_AllNurses.PerformNetworkRequest(Api.URL_DELETE_NURSE + nurseid, null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    private void refreshHeroList(JSONArray nurses) throws JSONException {
        ...
        Doctor_AllNurses.NurseAdapter adapter = new Doctor_AllNurses.NurseAdapter(nurseList);
    ...
    class NurseAdapter extends ArrayAdapter<Nurse> {
        ...
        public NurseAdapter(List<Nurse> nurseList) {
            super(Doctor_AllNurses.this, R.layout.layout_hero_list, nurseList);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textViewDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Doctor_AllNurses.this);
