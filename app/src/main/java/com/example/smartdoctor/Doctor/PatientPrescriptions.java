...
public class PatientPrescriptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_patient_prescriptions);
    ...
    private void readHeroes() {
        PatientPrescriptions.PerformNetworkRequest request = new PatientPrescriptions.PerformNetworkRequest(Api.URL_READ_PRESCRIPTIONS, null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    private void refreshAppointmentsList(JSONArray appointments) throws JSONException {
        ...
        PatientPrescriptions.PrescAdapter adapter = new PatientPrescriptions.PrescAdapter(prescriptionsList);
    ...
    class PrescAdapter extends ArrayAdapter<Prescriptions> {
        ...
        public PrescAdapter(List<Prescriptions> prescriptionsList) {
            super(PatientPrescriptions.this, R.layout.layout_prescriptions_list, prescriptionsList);
