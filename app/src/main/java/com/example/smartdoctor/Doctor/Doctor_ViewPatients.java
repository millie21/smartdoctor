...
public class Doctor_ViewPatients extends AppCompatActivity {
...
//        });
    ...
    class HeroAdapter extends ArrayAdapter<Hero> {
        ...
        public HeroAdapter(List<Hero> heroList) {
            super(Doctor_ViewPatients.this, R.layout.layout_hero_list, heroList);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textViewDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Doctor_ViewPatients.this);
